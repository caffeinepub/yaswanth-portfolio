...
function ParticleCanvas() {
  ...
  reactExports.useEffect(() => {
    ...
    const scatterDots = Array.from({ length: 28 }, () => ({
    ...
    const dataLabels = [
      { text: "87.3%", x: 0.3, y: 0.15, vy: -8e-5, alpha: 0.18, size: 11 },
      { text: "↑ 12.4", x: 0.63, y: 0.45, vy: -6e-5, alpha: 0.15, size: 10 },
      { text: "Q3", x: 0.82, y: 0.72, vy: -7e-5, alpha: 0.14, size: 12 },
      { text: "2024", x: 0.18, y: 0.65, vy: -9e-5, alpha: 0.16, size: 11 },
      { text: "94.1%", x: 0.48, y: 0.82, vy: -5e-5, alpha: 0.13, size: 10 },
      { text: "↓ 3.7", x: 0.07, y: 0.48, vy: -8e-5, alpha: 0.15, size: 11 },
      { text: "KPI", x: 0.93, y: 0.55, vy: -6e-5, alpha: 0.12, size: 10 },
      {
        text: "Σ 2,847",
        x: 0.37,
        y: 0.92,
    ...
    function drawBarGroups(w, h) {
      for (const g of barGroups) {
        ...
        for (let i = 0; i < g.bars.length; i++) {
          g.bars[i] += (g.targets[i] - g.bars[i]) * 8e-3;
        }
        const cx2 = g.x * w;
        const cy = g.y * h;
        const gap = 4;
        const totalW = g.bars.length * (g.w + gap);
        const startX = cx2 - totalW / 2;
    ...
    function drawSparkline(w, h) {
      ...
      for (let x = 0; x <= lineLen; x += 2) {
        const y = baseY - amplitude * Math.sin(x * freq + t * speed) - 10 * Math.sin(x * freq * 2.3 + t * speed * 0.7);
      ...
      for (let x = 0; x <= lineLen * 0.7; x += 2) {
        ...
        x === 0 ? ctx.moveTo(startX * 1.8 + x, y) : ctx.lineTo(startX * 1.8 + x, y);
      }
      ctx.strokeStyle = "rgba(50, 130, 255, 0.35)";
      ctx.lineWidth = 1.2;
      ctx.stroke();
    }
    function drawScatterDots(w, h) {
      for (const d of scatterDots) {
        const pulse = 0.5 + 0.5 * Math.sin(t * 0.04 + d.pulse);
        const alpha = d.alpha * (0.6 + 0.4 * pulse);
        const r2 = d.r * (0.9 + 0.2 * pulse);
        ctx.beginPath();
        ctx.arc(d.px * w, d.py * h, r2, 0, Math.PI * 2);
...
const PROJECTS = [
  {
    ...
    description: "Built an ML model to predict heart disease likelihood using patient data. Applied feature engineering and cross-validation for robust accuracy.",
    tags: ["Python", "Pandas", "Matplotlib"],
    status: "Completed",
    statusColor: "emerald",
    image: "/assets/generated/project-heart-disease.dim_600x340.jpg",
    link: "#",
    overview: "A machine learning model that predicts the risk of heart disease based on patient health attributes such as age, cholesterol, blood pressure, and more.",
    techStack: [
      "Python",
      "Pandas",
      "NumPy",
    ...
    workflow: [
      {
        ...
        detail: "Collected dataset with patient health attributes (age, cholesterol, BP, etc.)"
      },
      {
      ...
      },
      {
        ...
        detail: "Visualized correlations using graphs, identified key influencing features"
      },
      {
      ...
      },
      {
        ...
        detail: "Used accuracy, precision, recall; cross-validation for reliability"
      },
      {
        step: "Prediction System",
        detail: "Built Streamlit interface that accepts user input and predicts risk"
      }
    ],
    results: "Achieved reliable prediction accuracy using Random Forest; cross-validation confirmed model generalization. Streamlit interface allows real-time risk prediction.",
    github: "https://github.com/Yaswanthhh1432"
  },
  {
    id: 2,
    title: "Student Course Completion Analysis",
    description: "Analyzed student engagement and completion patterns across online courses using data analytics and visualization to identify key dropout factors.",
    tags: ["Python", "Pandas", "Matplotlib", "Seaborn"],
    status: "Completed",
    statusColor: "emerald",
    image: "/assets/generated/project-student-course.dim_600x340.jpg",
    link: "#",
    overview: "A data analysis project that examines student activity and course completion patterns to identify dropout factors and improve engagement.",
    techStack: [
      "Python",
      "Pandas",
      "NumPy",
    ...
    workflow: [
      ...
      },
      {
        ...
        detail: "Converted raw data into structured format, created meaningful columns (completion rate, engagement score)"
      },
      {
        step: "Exploratory Data Analysis",
        detail: "Analyzed patterns in course completion, dropout rates, engagement trends"
      },
      {
      ...
      },
      {
        ...
        detail: "Identified key factors affecting dropout, compared course performances"
      },
      {
        step: "Conclusion",
    ...
    results: "Identified key dropout triggers and engagement patterns. Visualizations clearly highlighted underperforming courses and suggested targeted interventions.",
    github: "https://github.com/Yaswanthhh1432"
  },
  {
    id: 3,
    title: "Social Media News Feed Algorithm",
    description: "Designed and simulated a personalized news feed ranking algorithm using engagement signals, user preferences, and content scoring.",
    tags: ["Python", "Machine Learning", "Algorithms", "NLP"],
    status: "Completed",
    statusColor: "emerald",
    image: "/assets/generated/project-social-feed.dim_600x340.jpg",
    link: "#",
    overview: "A ranking algorithm that generates personalized social media news feeds based on user engagement signals like likes, shares, comments, and preferences.",
    ...
    workflow: [
      ...
      },
      {
        ...
        detail: "Assigned scores based on user interaction, content popularity, recency"
      },
      {
        step: "Algorithm Design",
        detail: "Built ranking logic using ML concepts, prioritized relevant content"
      },
      {
      ...
      },
      {
        ...
        detail: "Tested algorithm with sample data, compared ranking performance"
      },
      {
        step: "Optimization",
    ...
    results: "Successfully ranked posts by relevance score. Personalized feeds showed improved content relevance compared to chronological ordering.",
    github: "https://github.com/Yaswanthhh1432"
  },
  {
    id: 4,
    title: "Financial Analysis Dashboard",
    description: "Built an interactive financial dashboard to analyze revenue trends, profit margins, and expense breakdowns using Python and Power BI.",
    tags: ["Python", "Power BI", "Excel", "Pandas"],
    status: "Completed",
    statusColor: "emerald",
    image: "/assets/generated/project-financial-dashboard.dim_600x340.jpg",
    link: "#",
    overview: "An interactive dashboard that consolidates financial data to provide insights into revenue trends, profit margins, expense distribution, and KPI tracking for data-driven decision making.",
    techStack: [
      "Python",
      "Pandas",
      "NumPy",
    ...
    workflow: [
      {
        step: "Data Collection",
        detail: "Gathered financial datasets including revenue, expenses, and profit records across multiple periods"
      },
      {
        step: "Data Cleaning",
        detail: "Removed inconsistencies, handled missing entries, and standardized date formats and currency values"
      },
      {
        step: "Data Transformation",
        detail: "Created calculated columns for profit margins, growth rates, and expense ratios"
      },
      {
        step: "Exploratory Data Analysis",
        detail: "Identified revenue trends, seasonal patterns, and top expense categories"
      },
      {
        step: "Dashboard Design",
        detail: "Designed interactive Power BI dashboard with KPI cards, bar charts, line graphs, and pie charts"
      },
      {
        step: "Insights Generation",
        detail: "Highlighted underperforming periods, high-cost segments, and revenue growth opportunities"
      },
      {
        step: "Reporting",
        detail: "Exported visual reports and summary for stakeholder presentation"
      }
    ],
    results: "Delivered a comprehensive financial overview dashboard with real-time KPI tracking. Identified a 15% cost reduction opportunity through expense analysis.",
    github: "https://github.com/Yaswanthhh1432"
  }
];
const STATUS_STYLES = {
...
const PHOTO_SRC = "/assets/uploads/SmartBG_2026-03-22_36f7a0b7-af0a-4d3a-80f6-72dac452858b-1.png";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "Yaswanth" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.82 0.15 195)" }, children: " / DS" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center gap-1", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              style: {
                color: activeSection === link.id ? "oklch(0.82 0.15 195)" : "oklch(0.72 0.02 220)"
              },
              children: [
                link.label,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              width: "900px",
              height: "500px",
              background: "radial-gradient(ellipse at 50% 0%, oklch(0.82 0.15 195 / 0.12) 0%, oklch(0.68 0.14 195 / 0.06) 45%, transparent 70%)",
              filter: "blur(20px)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              background: "radial-gradient(ellipse at center, oklch(0.82 0.15 195 / 0.22) 0%, oklch(0.68 0.14 195 / 0.10) 50%, transparent 70%)",
              filter: "blur(45px)",
              borderRadius: "50%"
            }
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              right: "2%",
              bottom: "8%",
              background: "radial-gradient(ellipse at center, oklch(0.72 0.15 195 / 0.18) 0%, transparent 65%)",
              filter: "blur(55px)",
              borderRadius: "50%"
            }
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              right: "-80px",
              top: "8%",
              background: "radial-gradient(ellipse at center, oklch(0.68 0.14 195 / 0.18) 0%, oklch(0.60 0.12 145 / 0.08) 50%, transparent 70%)",
              filter: "blur(50px)",
              borderRadius: "50%"
            }
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              left: "30%",
              top: "12%",
              background: "radial-gradient(ellipse at center, oklch(0.68 0.14 195 / 0.10) 0%, transparent 65%)",
              filter: "blur(40px)",
              borderRadius: "50%"
            }
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-6xl mx-auto w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-fade-up", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "animate-fade-up-delay-1 text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight tracking-tight mb-4", children: [
            "Hi, I'm",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.82 0.15 195)" }, children: "Yaswanth" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "Jayamangala" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Data Science Enthusiast | Data Analyst"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Turning raw data into meaningful insights, one model at a time."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-up-delay-4 flex flex-col sm:flex-row gap-4 justify-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                size: "lg",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "w-px h-8",
                  style: {
                    background: "linear-gradient(to bottom, oklch(0.50 0.02 220), transparent)"
                  }
                }
              )
            ]
...
function SectionDivider() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider", "aria-hidden": true });
}
function AboutSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(180deg, oklch(0.135 0.015 238 / 0.9) 0%, oklch(0.12 0.013 240) 100%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { title: "About Me", subtitle: "A little about myself" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-start mt-12", children: [
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      style: {
                        background: "linear-gradient(135deg, oklch(0.82 0.15 195 / 0.06) 0%, transparent 55%)"
                      }
                    }
                  )
                ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "h3",
              {
                ...
                children: [
                  "B.Tech CSE Student &",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.82 0.15 195)" }, children: "Data Science Minor" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: "oklch(0.72 0.02 220)" },
                children: "I'm a 3rd-year Computer Science Engineering student at Lovely Professional University (LPU), pursuing a minor in Data Science. I'm passionate about transforming complex datasets into actionable insights."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "leading-relaxed",
                style: { color: "oklch(0.72 0.02 220)" },
                children: "My journey spans predictive modeling, data analytics, and building machine learning pipelines — from raw preprocessing to model deployment. I love tackling real-world problems through the lens of data."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "leading-relaxed",
                style: { color: "oklch(0.72 0.02 220)" },
                children: "When I'm not training models or wrangling data, I'm exploring the latest in AI research and contributing to open-source data science projects."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 pt-2", children: [
              "Problem Solving",
              "Machine Learning",
              "Data Analytics",
              "Python"
...
function SkillsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", className: "py-24 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 space-y-10", children: SKILL_GROUPS.map((group) => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-sm tracking-wide uppercase", children: group.category })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: group.skills.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                onMouseEnter: (e) => {
                  e.currentTarget.style.borderColor = "oklch(0.82 0.15 195 / 0.4)";
                  e.currentTarget.style.color = "oklch(0.82 0.15 195)";
                  e.currentTarget.style.boxShadow = "0 0 12px oklch(0.82 0.15 195 / 0.2)";
                },
                onMouseLeave: (e) => {
                  e.currentTarget.style.borderColor = "oklch(0.94 0.01 220 / 0.1)";
                  e.currentTarget.style.color = "oklch(0.86 0.01 220)";
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            project.image && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-48 overflow-hidden rounded-t-2xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: project.image,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "absolute inset-0",
                  style: {
                    background: "linear-gradient(to bottom, transparent 40%, oklch(0.14 0.015 240) 100%)"
                  }
                }
              )
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 pt-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "space-y-3", children: project.workflow.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        className: "py-24 px-6 relative",
        style: {
          background: "linear-gradient(180deg, oklch(0.13 0.014 236 / 0.85) 0%, oklch(0.12 0.013 240) 100%)"
        },
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SectionHeading,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid sm:grid-cols-2 gap-6", children: PROJECTS.map((project, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "article",
            {
              ...
              onMouseEnter: (e) => {
                e.currentTarget.style.borderColor = "oklch(0.82 0.15 195 / 0.25)";
                e.currentTarget.style.boxShadow = "0 8px 40px oklch(0.82 0.15 195 / 0.08)";
              },
              onMouseLeave: (e) => {
                e.currentTarget.style.borderColor = "oklch(0.94 0.01 220 / 0.08)";
                e.currentTarget.style.boxShadow = "none";
              },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-44 overflow-hidden", children: [
                  project.image ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    "div",
                    {
                      ...
                      style: {
                        background: "linear-gradient(135deg, oklch(0.18 0.02 240), oklch(0.20 0.025 210))"
                      },
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-5", children: project.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
                      variant: "secondary",
                      className: "text-xs font-medium",
...
function InternshipSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      className: "py-24 px-6 relative",
      style: {
        background: "linear-gradient(180deg, oklch(0.135 0.015 238 / 0.8) 0%, oklch(0.12 0.013 240) 100%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SectionHeading,
            ...
            children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "h3",
                      {
                        ...
                        style: { color: "oklch(0.94 0.01 220)" },
                        children: "BSNL (Bharat Sanchar Nigam Limited)"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "h-px mb-8",
                  style: {
                    background: "linear-gradient(to right, oklch(0.82 0.15 195 / 0.2), transparent)"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-4", children: INTERNSHIP_BULLETS.map((bullet) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid sm:grid-cols-2 gap-6", children: CERTIFICATES.map((cert, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { size: 22, style: { color: "oklch(0.82 0.15 195)" } })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function CompetitiveSection() {
  ...
  const hackathons = [
    {
      ...
      role: "Team Member",
      outcome: "College-level Participation — Data Analytics Solution for Agriculture",
      badge: "SIH 2023"
    },
    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      className: "py-24 px-6 relative",
      style: {
        background: "linear-gradient(180deg, oklch(0.11 0.013 238 / 0.9) 0%, oklch(0.12 0.013 240) 100%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SectionHeading,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid md:grid-cols-3 gap-5", children: platforms.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { size: 20, style: { color: p.color } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: "font-bold text-base",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "oklch(0.65 0.03 220)" }, children: p.detail })
            ]
          },
          p.name
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 grid sm:grid-cols-2 gap-5", children: hackathons.map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            onMouseEnter: (e) => {
              e.currentTarget.style.borderColor = "oklch(0.82 0.15 195 / 0.3)";
              e.currentTarget.style.boxShadow = "0 8px 32px oklch(0.82 0.15 195 / 0.08)";
            },
            onMouseLeave: (e) => {
              e.currentTarget.style.borderColor = "oklch(0.82 0.15 195 / 0.12)";
              e.currentTarget.style.boxShadow = "none";
            },
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "oklch(0.65 0.03 220)" }, children: h.outcome })
            ]
          },
          h.name
        )) })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid sm:grid-cols-2 gap-6", children: articles.map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            onMouseEnter: (e) => {
              e.currentTarget.style.borderColor = "oklch(0.82 0.15 195 / 0.25)";
              e.currentTarget.style.boxShadow = "0 8px 32px oklch(0.82 0.15 195 / 0.07)";
            },
            onMouseLeave: (e) => {
              e.currentTarget.style.borderColor = "oklch(0.94 0.01 220 / 0.08)";
              e.currentTarget.style.boxShadow = "none";
...
function ResearchSection() {
  const papers = [
    {
      title: "Predictive Analysis of Student Course Completion Using Machine Learning",
      status: "Under Review",
      statusColor: "oklch(0.80 0.18 55)",
      statusBg: "oklch(0.80 0.18 55 / 0.12)",
      venue: "International Journal of Educational Technology",
      abstract: "Explores ML-based models (Random Forest, Logistic Regression) to predict student dropout rates and course completion probabilities using engagement metrics and historical academic data."
    },
    {
      ...
      venue: "Internal Publication — Lovely Professional University, Dept. of CSE",
      abstract: "Presents a scoring-based feed ranking algorithm using user interaction signals (likes, shares, comments) and content recency to generate personalized social media feeds."
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      className: "py-24 px-6 relative",
      style: {
        background: "linear-gradient(180deg, oklch(0.12 0.013 240) 0%, oklch(0.13 0.014 236 / 0.85) 100%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SectionHeading,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 flex flex-col gap-6", children: papers.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            onMouseEnter: (e) => {
              e.currentTarget.style.borderColor = p.statusColor.replace(")", " / 0.3)");
              e.currentTarget.style.boxShadow = `0 8px 32px ${p.statusColor.replace(")", " / 0.07)")}`;
            },
            onMouseLeave: (e) => {
              e.currentTarget.style.borderColor = "oklch(0.94 0.01 220 / 0.08)";
              e.currentTarget.style.boxShadow = "none";
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(FlaskConical, { size: 20, style: { color: p.statusColor } })
                  }
                ),
...
function EducationContactSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto grid md:grid-cols-2 gap-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: { color: "oklch(0.82 0.15 195)" },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { size: 24 }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    className: "text-2xl font-bold",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative pl-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  background: "linear-gradient(to bottom, oklch(0.82 0.15 195 / 0.4), oklch(0.82 0.15 195 / 0.15) 60%, transparent)"
                }
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-8", "data-ocid": "education.item.1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between flex-wrap gap-2 mb-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "h3",
                        {
                          className: "font-bold text-base",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        children: "Sasi English Medium High School, Eluru, Andhra Pradesh"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        style: { color: "oklch(0.55 0.02 220)" },
                        children: "Secondary School Certificate (SSC)"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-8", "data-ocid": "education.item.2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "absolute top-1.5 w-2.5 h-2.5 rounded-full border-2",
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        className: "font-medium text-sm",
                        style: { color: "oklch(0.72 0.05 200)" },
                        children: "AANM & VVRSR College of Engineering, Gudlavalleru"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        className: "text-sm mt-1",
                        style: { color: "oklch(0.55 0.02 220)" },
                        children: "Diploma in Computer Science Engineering"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", "data-ocid": "education.item.3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        className: "font-medium text-sm",
                        style: { color: "oklch(0.82 0.15 195)" },
                        children: "Lovely Professional University (LPU)"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        className: "text-sm mt-1",
                        style: { color: "oklch(0.65 0.02 220)" },
                        children: "Currently in 3rd Year"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "contact", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-8 text-sm", style: { color: "oklch(0.65 0.02 220)" }, children: "Open for internship opportunities. Let's connect!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 mb-8", children: [
            {
              icon: Mail,
              label: "Email",
          ...
          ].map(({ icon: Icon2, label, href, ocid }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href,
              target: href.startsWith("mailto") || href.startsWith("tel") ? void 0 : "_blank",
              rel: "noopener noreferrer",
              "data-ocid": ocid,
              title: label,
              ...
              onMouseEnter: (e) => {
                e.currentTarget.style.borderColor = "oklch(0.82 0.15 195 / 0.3)";
                e.currentTarget.style.color = "oklch(0.82 0.15 195)";
                e.currentTarget.style.boxShadow = "0 0 12px oklch(0.82 0.15 195 / 0.15)";
              },
              onMouseLeave: (e) => {
                e.currentTarget.style.borderColor = "oklch(0.94 0.01 220 / 0.1)";
                e.currentTarget.style.color = "oklch(0.72 0.02 220)";
                e.currentTarget.style.boxShadow = "none";
              },
              children: [
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    style: {
                      background: submitted ? "oklch(0.68 0.15 195)" : "oklch(0.82 0.15 195)",
                      color: "oklch(0.12 0.013 240)"
                    },
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "oklch(0.45 0.02 220)" }, children: [
        "© ",
        year,
        " Yaswanth Jayamangala. Built with ♥ using",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
...
function App() {
  ...
  reactExports.useEffect(() => {
    ...
    for (const t of targets) (_a2 = observerRef.current) == null ? void 0 : _a2.observe(t);
    return () => {
      var _a3;
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { zIndex: 1 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, { activeSection }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionDivider, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(InternshipSection, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionDivider, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CertificatesSection, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionDivider, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CompetitiveSection, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionDivider, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(BlogSection, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionDivider, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ResearchSection, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionDivider, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(EducationContactSection, {})
          ] }),
